...
- Erstellen Sie ein React-Projekt mit create-vite: `npm init --yes vite@latest viennamap.client -- --template=react-ts  --no-rolldown --no-immediate`..
...
- Projektdatei (`viennamap.client.esproj`) erstellen.
